...
В интерфейсе программы есть строка индикации номера и очередности хода. Фото позиций сохраняются с именем текста строки индикации, либо пользователь сохраняет, используя другой вариант.

Режим "Партия":
Нажмите кнопку "Партия" для начала новой партии. Будет предложено создать папку для сохранения фото позиций. Белые ходят первыми.

Режим "Анализ":
Нажмите кнопку "Анализ" для расстановки произвольной позиции. Используйте кассы фигур слева и справа от доски. После расстановки нажмите "Ок" для начала сеанса анализа позиции. Будет предложено создать папку для сохранения фото позиций при анализе исходной позиции.

Сохранение фото позиций:
Посредством команд Меню можно сохранять фото позиций либо в созданную пользователем папку (программа предложит), либо фото позиций будут сохраняться в стандартную папку Изображений.
